...
if(dolphinsAverageScore === koalasAverageScore && dolphinsAverageScore >= minScore && koalasAverageScore >= minScore){
    console.log(`Its A Draw You Both Win Trophies!!`) //done
} else if (dolphinsAverageScore < koalasAverageScore && koalasAverageScore >= minScore){
    console.log(`Team Koalas win the trophy!!`) //done
